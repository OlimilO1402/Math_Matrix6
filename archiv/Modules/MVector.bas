...
Public Function Vec10_ToArr(v As Vector10) As Double()
    ...
    With v: da(0) = .a: da(1) = .b: da(2) = .c: da(3) = .d: da(4) = .e: da(5) = .f: da(6) = .g: da(7) = .H: da(8) = .i: da(9) = .i: End With
    Vec10_ToArr = da
End Function
...
End Function
Public Function Vec10_ToStr(v As Vector10, Optional bIsLineVec As Boolean = False, Optional ByVal dFormat As Integer = 3) As String
