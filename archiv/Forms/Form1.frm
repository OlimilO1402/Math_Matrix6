...
'ok; Multiply vector
    ...
    With CmbOps
        ...
        .AddItem "  =  ": .AddItem "isSym": .AddItem "eigval"
...
Private Sub BtnCalc_Click()
    ...
    '
    'Mist, zuviele lokale nichtstatische Variablen
...
Private Sub Form_Resize()
    ...
    If W > 0 And H > 0 Then
        ...
        Dim L2: L2 = l - (brdr + CmbOps.Width) / 2
...
Private Sub Split1_OnMove(Sender As Splitter)
    ...
    Dim T As Single: T = Panel.Top
    l = l + Text1.Width + brdr
    Dim L2 As Single: L2 = l - (brdr + CmbOps.Width) / 2
    CmbOps.Move L2, T - CmbOps.Height
